...
$trang = ceil($rowCount / 20);

$page = "";
if(isset($_GET['indexTrang'])) {
    $page = $_GET['indexTrang'];
} else {
    $page = 1;
}
...
if($page == "" || $page == 1) {
    ...
    $begin_row = ($page * 20) - 20;
}


if($theloai == "ALL") {
    $result_show = $showCategory->getAllMusic18($begin_row);
} else {  
$result_show = $showCategory->getShowMusic18($theloai, $begin_row);
}
...
<div class="list-buttom">
    <ul>
      ...
      ?>
       <a href="ShowCategory.php?theloai=<?php echo $theloai?>&indexTrang=<?php echo $i;?>"> <li> <?php echo $i;?> </li> </a>
      <?php 
        }
      ?>
    </ul>
